...
var Player = function (name, health) {
  ...
  this.dropLastItem = function () {
      if (this.items.length > 0) {
          console.log("Dropped item: " + this.items.pop());
      } else {
...
var player2 = new Player("Riven", 75);
player2.place = library;
player2.addItem("an old map");
player2.addItem("a healing potion");

// Displaying each player's info
player1.showInfo("=");
player2.showInfo("#");

// Dropping the last item for each player and displaying updated info
player2.dropLastItem();  // Drops "a healing potion"
player2.showInfo("#");

player1.dropLastItem();  // Drops "The Sword of Doom"
player1.showInfo("=");
